    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('Male', 'Male'), ('Female', 'Female'), ('Other', 'Other')], default='Male', max_length=50, verbose_name='User Gender')),
                ...
                ('is_verified', models.BooleanField(default=False, verbose_name='Verify Account')),
